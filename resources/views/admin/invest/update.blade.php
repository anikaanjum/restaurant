      ...
      <div class="row mt-3">
          ...
          <div class="col-6" id="addForm">
            <div class="card card-primary">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form role="form" method="POST" action="{{action('InvestController@update')}}">
                  @csrf
                  <input type="hidden" name="id" value="{{$table->id}}">
                    <div class="card-body">
                    <div class="form-group">
                      <label for="">Invest Type</label>
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="" value="{{$table->amount}}" placeholder="Enter amount" name="amount">
                      </div>
                      <div class="form-group">
